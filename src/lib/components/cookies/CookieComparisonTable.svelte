<script lang="ts">
	...
	import SingleEntryModal from "../../../routes/(app)/cookies/single-entry-modal.svelte";
	import EntryModal from "../../../routes/(app)/cookies/entry-modal.svelte";
							...
							<Dialog>
								...
								>
									...
									{:else if type === "uniqueFirst"}
										<SingleEntryModal
											{key}
											CookieValue={firstCookieMap.get(
												key,
											)!}
										/>
									{:else if type === "uniqueSecond"}
										<SingleEntryModal
											{key}
											CookieValue={secondCookieMap.get(
												key,
											)!}
										/>
									{/if}
